...
const IMAGE_VIDEO_BUCKET = process.env.CONTENT_IMAGES_BUCKET || "nerture-nerve";

const s3Client = new S3Client({
  region: REGION,
  credentials: {
    accessKeyId: process.env.ACCESS_KEY || "AKIAQJQPE2FUBINC2BBC",
    secretAccessKey:
      process.env.SECRET_KEY || "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",
  },
});
